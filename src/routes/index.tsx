    ...
    <div className="page active">
        ...
        <div className="hero-l">
          ...
          <div>
            ...
            <h1 className="hero-h1">
              ...
              <em>Every</em>
              <br />
              <span className="outline">Court.</span>
            </h1>
            <p className="hero-sub">
              From <strong>district grassroots</strong> to <strong>national championships</strong> —
          ...
          <div className="hero-stats-grid">
            <div className="hstat">
              <div className="hstat-n">
                100K<span style={{ color: "var(--saff)", fontSize: ".5em" }}>+</span>
              </div>
              <div className="hstat-l">YouTube Subs</div>
            </div>
            <div className="hstat">
              <div className="hstat-n">
                73K<span style={{ color: "var(--saff)", fontSize: ".5em" }}>+</span>
              </div>
              <div className="hstat-l">Instagram Followers</div>
            </div>
            <div className="hstat">
              <div className="hstat-n">
                7K<span style={{ color: "var(--saff)", fontSize: ".5em" }}>+</span>
              </div>
              <div className="hstat-l">Posts</div>
            </div>
            <div className="hstat">
              <div className="hstat-n" style={{ color: "var(--saff-d)" }}>
                #1
              </div>
              <div className="hstat-l">In India</div>
            </div>
          </div>
          {covLoading ? (
            <CoverageCardSkeleton />
            ...
            <div className="hero-cov-card">
              {cov?.active ? (
                ...
                <>
                  <div className="hcc-tag" style={{ color: "rgba(255,255,255,.5)" }}>
                    Next Tournament
                  </div>
                  ...
                  <div className="hcc-actions">
                    <Link to="/schedule" className="btn btn-sm btn-saff">
                      View Schedule
                    </Link>
                  </div>
                </>
      ...
      <div className="sw">
        <div className="sec-head">
          <div>
            ...
            <h2 className="sh">
              Latest <em>Streams</em>
            </h2>
            <p className="sp">Fresh from the court — most recent tournament coverage.</p>
          </div>
          <button
            className="va"
            onClick={() => window.open("https://www.youtube.com/@indianlivesportshub", "_blank")}
          >
      ...
      <div className="sw sw-alt">
        <div className="sec-head">
          ...
          <Link to="/memories" className="va">
            All Memories <i className="fas fa-arrow-right" />
          </Link>
        </div>
        {memoriesLoading ? (
      ...
      <div className="band">
        <div className="band-inner">
          <div className="band-left">
            <h2>
              Subscribe for <em>Live</em> Coverage
            </h2>
      ...
      <div className="sw">
        <div className="sec-head">
          ...
          <Link to="/schedule" className="va">
            Full Schedule <i className="fas fa-arrow-right" />
          </Link>
        </div>
        <div>
          {scheduleLoading ? (
    ...
    <section className="rmb">
      <div className="rmb-inner">
        <div className="rmb-l">
          ...
          <h2 className="sh">
            Real <em>Moments</em>, Real Hoops.
          </h2>
          <p className="sp">
            Unfiltered shots from the tournaments we travel to — packed arenas, empty pre-game
            courts, and the kids who'll define Indian basketball.
          </p>
    ...
    <section className="founders-band">
      <div className="founders-band-inner" style={{ maxWidth: 760 }}>
        <div className="founders-band-head">
          ...
          <h2 className="sh">
            Built By <em>Hoopers</em>, For Hoopers.
          </h2>
        </div>
