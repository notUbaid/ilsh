      ...
      <div className="page active">
        <div style={{ padding: "90px 5%", textAlign: "center" }}>
          <div className="empty">
            ...
            <br />
            <Link to="/schedule" className="btn btn-saff">
              View Our Schedule
            </Link>
          </div>
        </div>
    ...
    <div className="page active">
      <div className="cov-hero">
        ...
        <div className="cov-hero-inner">
          ...
          <div className="meta-row">
            <div className="mbox">
              <div className="mbox-ico">📍</div>
              <div className="mbox-l">City</div>
              <div className="mbox-v">{cov.city}</div>
            </div>
            <div className="mbox">
              <div className="mbox-ico">🏟️</div>
              <div className="mbox-l">Venue</div>
              <div className="mbox-v">{cov.venue}</div>
            </div>
            <div className="mbox">
              <div className="mbox-ico">📅</div>
              <div className="mbox-l">From</div>
              <div className="mbox-v">{fmt(cov.start_date)}</div>
            </div>
            <div className="mbox">
              <div className="mbox-ico">🏁</div>
              <div className="mbox-l">Until</div>
              <div className="mbox-v">{fmt(cov.end_date)}</div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 11, flexWrap: "wrap" }}>
            <a href={cov.yt_url ?? "#"} target="_blank" rel="noreferrer" className="btn btn-yt">
              <i className="fab fa-youtube" />
              Watch on YouTube
            </a>
            <a href={cov.ig_url ?? "#"} target="_blank" rel="noreferrer" className="btn btn-ghost">
      ...
      <div className="cov-feed">
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          <h2 className="sh" style={{ marginBottom: 28 }}>
            Follow the <em>Action</em>
          </h2>
          <div className="feed-box">
            <span className="feed-icon">📸</span>
            <h3>Real-Time on Instagram & YouTube</h3>
            <p>
              We post live photos, behind-the-scenes moments, and highlights from the court as they
              happen.
            </p>
            <div style={{ display: "flex", gap: 11, justifyContent: "center", flexWrap: "wrap" }}>
              <a href={cov.ig_url ?? "#"} target="_blank" rel="noreferrer" className="btn btn-ig">
                <i className="fab fa-instagram" />
                Open Instagram
              </a>
              <a href={cov.yt_url ?? "#"} target="_blank" rel="noreferrer" className="btn btn-yt">
