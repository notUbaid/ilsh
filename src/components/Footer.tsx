    ...
    <footer>
      <div className="ft">
        <div className="fb-brand">
          ...
          <p>
            India's first dedicated basketball streaming channel. From district grassroots to
            national championships — we cover every court.
          </p>
        </div>
        <div>
          ...
          <ul className="flinks">
            ...
            <li>
              <Link to="/covering">Covering Now</Link>
            </li>
          </ul>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="flinks">
            <li>
              <a href="mailto:indianlivesportshub96@gmail.com">indianlivesportshub96@gmail.com</a>
            </li>
            <li>
